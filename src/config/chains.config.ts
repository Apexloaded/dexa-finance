import { bscTestnet, Chain, bsc } from "viem/chains";
import { Environment, getCurrentEnvironment } from "./env.config";
...
export const SUPPORTED_CHAINS: Record<Environment, [Chain, ...Chain[]]> = {
  ...
  [Environment.staging]: [bsc, bscTestnet],
  [Environment.production]: [bsc, bscTestnet],
};
